...
<html>
    ...
    <body>
        ...
        <div style="width:75%; margin-left: 12.5%; padding-top: 20px;">
            ...
            <i style="color:gray;">//showing {{count($songs)}} songs</i>
            @if(count($songs) < 1)
            ...
            <div style="display:flex; align-items: flex-start;"> 
                ...
                <div style="display: inline-block; padding: 15px 0px; width: 3%; border-radius: 0px 23px 23px 0px; background-color: {{$themes[$song->genre_id -1]->theme}};">
